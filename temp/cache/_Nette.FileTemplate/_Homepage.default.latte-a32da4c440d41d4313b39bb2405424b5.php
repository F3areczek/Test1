<?php //netteCache[01]000370a:2:{s:4:"time";s:21:"0.46261300 1394102195";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:56:"D:\www\DatabazeKnih\app\templates\Homepage\default.latte";i:2;i:1392094558;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:22:"released on 2014-02-08";}}}?><?php

// source file: D:\www\DatabazeKnih\app\templates\Homepage\default.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'lt36i2lrk8')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb77ce045862_content')) { function _lb77ce045862_content($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
<div id="content">
	...
	<section id="template">
		...
		<pre><code class="jush"><?php echo Nette\Templating\Helpers::escapeHtml($template->replacere(file_get_contents($presenter->template->getFile()), '#[\w+/]{60,}#', '…'), ENT_NOQUOTES) ?></code></pre>
	</section>
	...
	<footer>PHP <?php echo Nette\Templating\Helpers::escapeHtml(PHP_VERSION, ENT_NOQUOTES) ?> |
		<?php if (isset($_SERVER['SERVER_SOFTWARE'])) { ?>Server <?php echo Nette\Templating\Helpers::escapeHtml($_SERVER['SERVER_SOFTWARE'], ENT_NOQUOTES) ;} ?> |
...
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lba675c274bc_title')) { function _lba675c274bc_title($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_l->blocks['scripts'][] = '_lbe1ecb7ff26_scripts')) { function _lbe1ecb7ff26_scripts($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lbcade36af11_head')) { function _lbcade36af11_head($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
	...
	.box img { float: left; }
	.box p { clear: both; }
	.box p a { color: #006aeb; background: #f7f7f7; padding: 1px 3px; border-radius: 3px; text-decoration: none; box-shadow: 0 2px 5px rgba(0, 0, 0, .10); }
	.box p a:hover, .box p a:active, .box p a:focus { color: white; background-color: #006aeb; }
