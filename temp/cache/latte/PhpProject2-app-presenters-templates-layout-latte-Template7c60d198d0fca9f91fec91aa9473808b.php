<?php
// source: C:\xampp\htdocs\PhpProject2\app\presenters/templates/@layout.latte

class Template7c60d198d0fca9f91fec91aa9473808b extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('88932be705', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb1bb743f334_head')) { function _lb1bb743f334_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb19be0c3c7a_scripts')) { function _lb19be0c3c7a_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
